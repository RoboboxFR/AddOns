...
#include <NewPing.h> // ajoute la biblioth̬que du capteur ultrason

NewPing sonar(2, A5, 100); // cr̩̩ un objet sonar
int distance;

typedef enum { 
  input, servomotor, pwm, digital,x } 
pinType;
...
void configurePins()
{
  ...
  arduinoPins[8].type=digital;
  arduinoPins[9].type=digital;
  arduinoPins[10].type=digital; //a mettre en com
...
void sendSensorValues()
{
  ...
  if (distance !=0){
  ScratchBoardSensorReport(5, distance);
  }
